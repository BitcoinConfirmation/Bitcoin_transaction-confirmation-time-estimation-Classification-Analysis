...
ClassList=[2,4,6,8]
alg_List =['xgBoostLSTM0Layer','xgBoostLSTM1Layer','xgBoostLSTM2Layer','xgBoostLSTM3Layer','xgBoostLSTM4Layer','xgBoostLSTM5Layer','xgBoostLSTM6Layer','xgBoostLSTM7Layer']
...
def GetMetricResult(testgroup,alg_List):
    ...
    df.to_csv(str(testgroup) + 'AllAlgorithmsSelectedLSTMLayers.csv')
