...
ClassList=[2,4,6,8]
alg_List =[
    'finalLSTMSimpleLayers','finalLSTMSimpleLayersMemPos','xgBoost','xgBoostMemPos','xgBoostLSTM0LayerSimpleLayers','xgBoostLSTM0Layer']
...
def GetMetricResult(testgroup,alg_List):
    ...
    df.to_csv(str(testgroup) + 'AllAlgorithmsSelectedMemPos.csv')
