...
def selfAttentionmempoolModel(FC_units,lstmunits,lstmtimestamps,blockFeatureDim,MemFeatureDim,txFeatureDim):
  np.random.seed(9)
...
fel_model = selfAttentionmempoolModel(FC_units, lstmunits, lstmtimestamps, BocFeaLens,MemFeaLens, TxFeaLens)
