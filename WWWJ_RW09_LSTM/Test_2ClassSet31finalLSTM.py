...
def LSTMModel(FC_units,lstmunits,lstmtimestamps,blockFeatureDim,MemFeatureDim,txFeatureDim):
  np.random.seed(9)
...
fel_model = LSTMModel(FC_units, lstmunits, lstmtimestamps, BocFeaLens,MemFeaLens, TxFeaLens)
