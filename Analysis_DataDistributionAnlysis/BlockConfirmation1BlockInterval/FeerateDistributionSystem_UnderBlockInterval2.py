...
def GenerateFeerateTimePoints(TestGroup,blockInterval,fee_split):
    ...
    # plt.axvline(3*(1.1**5),ls='--', c='red')
    # plt.axvline(3 * (1.1 ** 11),ls='--', c='red')
    # plt.axvline(3 * (1.1 ** 17),ls='--', c='red')
    # plt.axvline(3 * (1.1 ** 23),ls='--', c='red')
    # plt.axvline(3 * (1.1 ** 30),ls='--', c='red')
    #
    #
    ...
    plt.savefig('FeerateDistributionSystem2.pdf')
