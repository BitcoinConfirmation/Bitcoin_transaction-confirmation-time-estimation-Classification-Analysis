...
TxSumit=pd.read_csv('transactions-per-second.csv', sep=",")
DataInfo=TxSumit.values
Txrate=DataInfo[:,1]
...
plt.xlabel('Time')
plt.ylabel('Transaction submittion per second')
plt.plot(Txrate,linewidth=1)
plt.savefig("Transactionsubmittionpersecond.pdf")
plt.show()
