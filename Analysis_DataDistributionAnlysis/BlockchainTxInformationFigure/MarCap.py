...
MarketCap=pd.read_csv('marketcap.csv', sep=",")
DataInfo=MarketCap.values
marketcap=DataInfo[:,1]
...
plt.plot(marketcap,linewidth=1)
plt.savefig("Marketcapitalization.pdf")
plt.show()
