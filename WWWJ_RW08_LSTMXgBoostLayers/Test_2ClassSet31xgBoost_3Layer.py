...
for i in range(1):
    ...
    update_model = load_model(filepath_fel)
    middle_model = Model(inputs=update_model.input, outputs=update_model.get_layer('Dense_FC_3').output)
