...
def WhtModel(FC_units,lstmunits,lstmtimestamps,blockFeatureDim,MemFeatureDim,txFeatureDim):
  np.random.seed(9)
...
fel_model = WhtModel(FC_units, lstmunits, lstmtimestamps, BocFeaLens,MemFeaLens, TxFeaLens)
