...
def QVKModel(layers,lstmunits,lstmtimestamps,blockFeatureDim,MemFeatureDim,txFeatureDim,classes):
  np.random.seed(9)
...
for classes in classes_list:
    ...
    ####Construct Training and Testing dataset
        ...
        fel_model = QVKModel(layers, lstmunits, lstmtimestamps, BocFeaLens,MemFeaLens, TxFeaLens,REAL_classLimit)
