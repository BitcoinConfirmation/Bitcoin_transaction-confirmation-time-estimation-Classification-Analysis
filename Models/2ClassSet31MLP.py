...
def MLPModel(layers,txFeatureDim,classes):
  np.random.seed(9)
...
for classes in classes_list:
    ...
    ####Construct Training and Testing dataset
        train_txfeatureList1,train_txOutputList1=txDatasetConstruction(txfile,blockfile,memfile,lstmtimestamps,START_EstimateBlock-training_blocks,START_EstimateBlock+total_EstimateBlock,classes, discretization, smallest_classes)
        #######Scale Features
        ...
        train_txfeatureList,train_txOutputList=txDatasetConstruction(txfile,blockfile,memfile,lstmtimestamps,lastUpdateHeight-training_blocks,lastUpdateHeight,classes, discretization, smallest_classes)
        #######Scale Features
    ...
    # convert integers to dummy variables (one hot encoding)
        ...
        fel_model = MLPModel(layers, TxFeaLens,REAL_classLimit)
