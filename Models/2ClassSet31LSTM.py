...
def selfLSTMModel(layers,lstmunits,lstmtimestamps,blockFeatureDim,MemFeatureDim,txFeatureDim,classes):
  np.random.seed(9)
  model2_input1 = Input(shape=(lstmtimestamps, blockFeatureDim), name='model2_input1')
  self_attention_out1 = LSTM(lstmunits)(model2_input1)

  model2_input2 = Input(shape=(lstmtimestamps, MemFeatureDim), name='model2_input2')
  self_attention_out2 = LSTM(lstmunits)(model2_input2)
...
for classes in classes_list:
    ...
    ####Construct Training and Testing dataset
        ...
        fel_model = selfLSTMModel(layers, lstmunits, lstmtimestamps, BocFeaLens,MemFeaLens, TxFeaLens,REAL_classLimit)
